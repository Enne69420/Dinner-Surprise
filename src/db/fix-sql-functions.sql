-- Fix all SQL Functions with Function Search Path Mutable issues

-- First, handle the create_user function
-- This fixes the trigger function that creates profiles for new users
...
-- Also fix handle_new_user function (if it exists and is different from create_user)
DO $$
BEGIN
  IF EXISTS (
